    ...
    <div class="p-4 sm">
        ...
        <div class="p-4 rounded-lg bg-white border border-gray-200">
            <div
                ...
                <!-- Form Filter -->
                <form method="GET" action="{{ route('gudang.distribusi-barang.filter') }}" id="filterForm"
                ...
                <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                    <thead class="bg-gradient-to-r from-green-400 to-green-600 text-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-sm font-medium uppercase tracking-wider border-b">Update
                                Status
                            </th>
